...
<html lang="en">
    <head>
        ...
        <title>Edit Jenis Produk - Sherpa Mart</title>
					...
					<form method="POST" action="proses_jenisproduk.php">
    					...
    					<label for="jenis_produk" class="col-4 col-form-label">Jenis Produk</label> 
    						<div class="col-8">
      							<div class="input-group">
        							...
        							<input id="jenis_produk" name="jenis_produk" type="text" class="form-control" value="<?= $row['jenis_produk']?>">
      							</div>
    						</div>
 					 	</div>
						<br>
                        <div class="form-group row">
                            <div class="offset-4 col-8">
                                ...
                                <a href="jenis_produk.php" class="btn btn-warning text-light">Kembali</a>
                            </div>
  						</div>
				    </form>
                    </div>
